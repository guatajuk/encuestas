...
q34 = Question.create!(item: "Presenta el programa en una estructura lógica, acorde con los objetivos del mismo", aspect_id: a2.id,)
q35 = Question.create!(item: "Desarrolla el programa en forma secuencial, y acorde con los objetivos del mismo", aspect_id: a2.id,)
q36 = Question.create!(item: "La metodología del trabajo corresponde a las características del grupo", aspect_id: a2.id,)
q37 = Question.create!(item: "La metodología del trabajo corresponde a las características de la temática del área", aspect_id: a2.id,)
q38 = Question.create!(item: "Se autoevalúa para mejorar su actividad como docente", aspect_id: a2.id,)
q39 = Question.create!(item: "Actualiza periódicamente sus programas y clases en contenidos, metodología y bibliografía", aspect_id: a2.id,)
q40 = Question.create!(item: "El sistema evaluativo es coherente con las formas metodológicas empleadas", aspect_id: a2.id)
q41 = Question.create!(item: "Presenta el plan y el informe de actividades", aspect_id: a3.id)
q42 = Question.create!(item: "Es responsable y cumplido en los trabajos que se le asignan", aspect_id: a3.id)
q43 = Question.create!(item: "Cumple con la jornada de trabajo", aspect_id: a3.id)
q44 = Question.create!(item: "Cumple con el horario de clases", aspect_id: a3.id)
q45 = Question.create!(item: "Cumple con las asesorías programadas con los estudiantes", aspect_id: a3.id)
q46 = Question.create!(item: "Se interesa por el trabajo colectivo", aspect_id: a3.id)
q47 = Question.create!(item: "Cumple con las actividades programadas por el Departamento", aspect_id: a3.id)
q48 = Question.create!(item: "Atiende el proceso de presentación de notas", aspect_id: a3.id)
q49 = Question.create!(item: "Cumple con las comisiones que se encargan", aspect_id: a3.id)
q50 = Question.create!(item: "Las relaciones con los compañeros de trabajo son respetuosas y cordiales", aspect_id: a4.id)
q51 = Question.create!(item: "Su relación con los estudiantes es cordial y respetuosa", aspect_id: a4.id)
q52 = Question.create!(item: "Comunica oportunamente a las personas que corresponde, para suspender o cambiar actividades programadas", aspect_id: a4.id)
q53 = Question.create!(item: "Analiza y discute con respeto las ideas de los demás", aspect_id: a4.id)
